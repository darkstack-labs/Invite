...
const DesktopDressCodeLayout = () => {
  ...
  const tabs: { id: Tab; label: string; icon: React.ReactNode }[] = [
    { id: 'general', label: 'General Guidelines', icon: <Crown className="w-4 h-4" /> },
    { id: 'men', label: 'For Gentlemen', icon: <ManSuitIcon className="w-4 h-4" /> },
    { id: 'women', label: 'For Ladies', icon: <WomanDressIcon className="w-4 h-4" /> },
  ];
  ...
  return (
    <motion.div 
      ...
      className="min-h-[calc(100dvh-5rem)] px-12 py-10 relative overflow-hidden"
    >
      {/* Premium Background Effects */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div
          className="absolute top-10 -left-48 w-[500px] h-[500px] rounded-full"
          style={{
        ...
        />
        <motion.div
          className="absolute bottom-10 -right-48 w-[600px] h-[600px] rounded-full"
          style={{
      ...
      <motion.button
        ...
        className="flex items-center gap-2 text-gold mb-8 hover:text-champagne transition-colors group relative z-10"
      >
        <motion.div
          animate={{ x: [0, -3, 0] }}
      ...
      >
        ...
        >
          <motion.div
            ...
            className="relative"
          >
            <Crown className="w-14 h-14 text-gold mx-auto" style={{
        ...
        <motion.div className="flex items-center justify-center gap-5 mb-4">
          <motion.div
          ...
          <h1 className="font-display text-gradient-gold font-bold text-4xl lg:text-5xl tracking-wide">
            Cocktail Attire
          </h1>
          <motion.div
        ...
        <motion.p
          ...
          className="text-gold italic text-sm tracking-[0.2em] uppercase"
        >
        ...
        <motion.div
          ...
          className="relative w-52 h-[2px] mx-auto mt-5"
        >
      ...
      {/* Side-by-Side Content - Larger Images */}
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="grid grid-cols-5 gap-8 max-w-6xl mx-auto relative z-10"
        >
          {/* Large Inspiration Image - Takes 2 columns */}
          <div className="col-span-2 relative rounded-2xl overflow-hidden" style={{
            border: '1px solid rgba(212, 175, 55, 0.35)',
            boxShadow: '0 20px 60px rgba(0, 0, 0, 0.5), 0 0 50px rgba(212, 175, 55, 0.15)',
          }}>
            <motion.div
            ...
            <motion.div
              ...
              animate={{ x: [500, -500] }}
              transition={{ duration: 6, repeat: Infinity, repeatType: 'reverse', ease: 'easeInOut', delay: 1.2 }}
            />
            
            {activeTab === 'general' ? (
              <div className="w-full min-h-[500px] bg-black/50 flex items-center justify-center">
                <img 
              ...
              <div className="relative w-full min-h-[500px] bg-black/50 flex items-center justify-center">
                <AnimatePresence mode="wait">
                  <motion.img
                ...
                <button
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 z-30 p-3 rounded-full bg-black/50 text-gold hover:bg-black/70 transition-colors"
                >
                  <ChevronLeft className="w-6 h-6" />
                </button>
                <button
                  onClick={handleNextImage}
                  className="absolute right-4 top-1/2 -translate-y-1/2 z-30 p-3 rounded-full bg-black/50 text-gold hover:bg-black/70 transition-colors"
                >
            ...
            <div className="absolute bottom-6 left-6 right-6">
              ...
              <p className="text-champagne/80 text-sm">
                {activeTab === 'general' && 'Timeless elegance for every guest'}
                {activeTab === 'men' && 'Sharp, sophisticated, and refined'}
                {activeTab === 'women' && 'Grace, poise, and understated luxury'}
              </p>
            </div>
          </div>

          {/* Rules Card - Takes 3 columns */}
          <div className="col-span-3 flex flex-col gap-5">
            {/* Color Swatches - Only show for men/women tabs */}
            {activeTab !== 'general' && (
              <div className="p-5 rounded-xl" style={{
                background: 'linear-gradient(135deg, rgba(20, 20, 25, 0.95) 0%, rgba(15, 15, 18, 0.98) 100%)',
                ...
                <div className="flex gap-3 flex-wrap">
                  {colorSwatches[activeTab].map((swatch, index) => (
                    ...
                    >
                      <div
                        className="w-12 h-12 rounded-full border-2 border-gold/30 shadow-lg cursor-pointer transition-transform hover:scale-110"
                        style={{ backgroundColor: swatch.color }}
                      />
                      <span className="text-[11px] text-champagne/60 group-hover:text-champagne/90 transition-colors">
                        {swatch.name}
                      </span>
                    </motion.div>
                  ))}
            ...
            <Card className="overflow-hidden relative flex-1" style={{
              background: 'linear-gradient(135deg, rgba(20, 20, 25, 0.95) 0%, rgba(15, 15, 18, 0.98) 100%)',
              border: '1px solid rgba(212, 175, 55, 0.25)',
              boxShadow: '0 20px 60px rgba(0, 0, 0, 0.5), 0 0 50px rgba(212, 175, 55, 0.12)',
            }}>
              <motion.div
              ...
              <CardContent className="p-8 relative h-full">
                <h2 className="text-gold font-display text-xl mb-6 flex items-center gap-3">
                  <Crown className="w-5 h-5" />
                  {activeTab === 'general' && 'Universal Guidelines'}
                  {activeTab === 'men' && 'Gentlemen\'s Attire'}
                  {activeTab === 'women' && 'Ladies\' Attire'}
                </h2>
                ...
                <div className="grid grid-cols-1 gap-3">
                  {getCurrentRules().map((rule, index) => (
                    <motion.div
                      ...
                      className="flex items-start gap-4 p-4 rounded-xl transition-all duration-300 hover:bg-gold/5 group"
                      style={{
                    ...
                    >
                      ...
                      <p className="text-champagne/90 leading-relaxed group-hover:text-champagne transition-colors">
                        {rule.text}
                      </p>
                    </motion.div>
                  ))}
      ...
      >
        <motion.div
          animate={{ 
            boxShadow: [
              '0 0 30px rgba(239, 68, 68, 0.1), 0 0 60px rgba(212, 175, 55, 0.1)',
              '0 0 45px rgba(239, 68, 68, 0.2), 0 0 90px rgba(212, 175, 55, 0.15)',
              '0 0 30px rgba(239, 68, 68, 0.1), 0 0 60px rgba(212, 175, 55, 0.1)'
            ]
          }}
        ...
        >
          <p className="text-red-400/90 font-medium flex items-center gap-3 justify-center">
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 1 }}
        className="mt-6 flex justify-center gap-6 text-sm relative z-10"
      >
        {[
...
export default DesktopDressCodeLayout;
